    ...
    <>
              ...
              {pageLinks.map((linkDetails, index) => {
                ...
                return(
                  <li key={index}>
                    ...
                    <Link className={location?.pathname === "link"? "link active" : "link"} to={link}>
                      {label}
                    </Link>
      ...
      <Modal modalOpened={navOpened}>
        <div className="mobile-nav" style={{ left: navPosition}}>
          ...
          <p className="mobile-nav-description">Discover the most outstanding wears at Mumiah fashion</p>
